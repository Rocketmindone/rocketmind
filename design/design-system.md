...
| Токен | px | Вес | Line-height | Letter-spacing | Применение |
|-------|----|-----|------------|---------------|-----------|
| `label-19` | 19 | 600 SemiBold | 1.2 | 0.03em | Маркетинговые акценты, hero-теги, крупные badges |
...
- Шрифт интерактивных элементов (кнопки, nav, теги) — Loos Condensed, uppercase, `letter-spacing: 0.08em`

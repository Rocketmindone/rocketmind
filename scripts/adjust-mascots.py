...
ADJUSTMENTS = {
    "max":    {"scale": 1.15, "files": None},           # +15% all
    "nick":   {"scale": 0.85, "files": None},           # -15% all
    "mark":   {"scale": 0.85, "files": None},           # -15% all
    "sergey": {"scale": 0.85, "files": None},           # -15% all
    "alex":   {"scale": 0.85, "files": ["base", "confident"]},  # -15% base+confident only
}
